    ...
    <div id="sa_tab_content_card" class="hidden space-y-6">
        ...
        <div class="space-y-4">
            <div>
                ...
                <input type="text" class="custom-input" placeholder="{user.idname} just joined the server" value="{user.idname} just joined the server" oninput="updateSaCardValue('title', this.value)">
            </div>
            <div>
                <label class="config-label">Subtitle</label>
                <input type="text" class="custom-input" placeholder="Member # {server.member_count}" value="Member # {server.member_count}" oninput="updateSaCardValue('subtitle', this.value)">
            </div>
        </div>
        ...
        <div class="welcome-card-preview w-full max-w-[520px] mx-auto" id="sa_card_preview_wrap">
            ...
            <div class="card-content">
                ...
                <div class="card-title" id="sa_card_title_text">manav6516#0 just joined the server</div>
...
window.initializeScheduledMessage = function() {
    ...
    function applyCardStyles() {
        ...
        title.textContent = card.title || defaultCardState.title;
        subtitle.textContent = card.subtitle || defaultCardState.subtitle;
