        ...
        <div class="unified-preview">
            <div class="welcome-card-preview w-full max-w-[520px] mx-auto" id="dm_card_preview_wrap">
                ...
                <div class="card-content">
                    ...
                    <div class="card-title" id="dm_card_title_text">manav6516#0 just joined the server</div>
...
window.initializeJoinPrivateMessage = function() {
    ...
    function applyDmCardFontSizes() {
        ...
        fitDmCardText(titleEl, card.titleSize || 56, 24);
        fitDmCardText(subtitleEl, card.subtitleSize || 36, 18);
    }
    ...
    window.addEventListener('resize', applyDmCardFontSizes);
};
