...
class Database:
    ...
    def _load_db(self) -> Dict:
        ...
        default_db = {
            ...
            "settings": {
                ...
                "commands_achievements": {"enabled": False, "role_ids": []},
                "commands_afk": {"enabled": False, "role_ids": []},
                "commands_autorole": {"enabled": False, "role_ids": []},
                "commands_backup": {"enabled": False, "role_ids": []},
                "commands_event": {"enabled": False, "role_ids": []},
                "commands_events": {"enabled": False, "role_ids": []},
                "commands_giveaway_export": {"enabled": False, "role_ids": []},
                "commands_health_check": {"enabled": False, "role_ids": []},
                "commands_help_admin": {"enabled": False, "role_ids": []},
                "commands_help": {"enabled": False, "role_ids": []},
                "commands_leaderboard_post": {"enabled": False, "role_ids": []},
                "commands_level_rewards": {"enabled": False, "role_ids": []},
                "commands_moderation": {"enabled": False, "role_ids": []},
                "commands_ping": {"enabled": False, "role_ids": []},
                "commands_poll": {"enabled": False, "role_ids": []},
                "commands_profile": {"enabled": False, "role_ids": []},
                "commands_punishment": {"enabled": False, "role_ids": []},
                "commands_quests": {"enabled": False, "role_ids": []},
                "commands_reputation_config": {"enabled": False, "role_ids": []},
                "commands_role_config": {"enabled": False, "role_ids": []},
                "commands_role": {"enabled": False, "role_ids": []},
                "commands_thank": {"enabled": False, "role_ids": []},
                "commands_ticket_setup": {"enabled": False, "role_ids": []},
                "commands_ticket": {"enabled": False, "role_ids": []},
                "commands_xp": {"enabled": False, "role_ids": []}
            },
            "last_server": None,
            "servers": {}
        }
        ...
        if os.path.exists(DB_FILE):
            with open(DB_FILE, "r") as f:
                try:
                    ...
                    # Ensure all new commands exist
                    new_cmds = [
                        "achievements", "afk", "autorole", "backup", "event", "events", 
                        "giveaway_export", "health_check", "help_admin", "help", 
                        "leaderboard_post", "level_rewards", "moderation", "ping", "poll", 
                        "profile", "punishment", "quests", "reputation_config", 
                        "role_config", "role", "thank", "ticket_setup", "ticket", "xp"
                    ]
                    for cmd in new_cmds:
                        key = f"commands_{cmd}"
                        if key not in data["settings"]:
                            data["settings"][key] = {"enabled": False, "role_ids": []}
    ...
    async def get_guild_payload(self, guild_id: str) -> Dict:
        ...
        # Increased timeout to 30s to handle slow Discord API responses
        async with httpx.AsyncClient(timeout=30.0) as client:
            try:
                ...
                return {"success": False, "error": "discord_api_timeout", "guild": {}, "channels": [], "roles": []}
            except Exception as e:
                return {"success": False, "error": str(e), "guild": {}, "channels": [], "roles": []}
    ...
    def get_xp_config(self, guild_id: str) -> Dict:
        levels_config = self.get_config(guild_id, "levels") or {}
        return {
            "xp_min": int(levels_config.get("xp_min", 15)),
            "xp_max": int(levels_config.get("xp_max", 25)),
